    ...
    <section className="relative min-h-screen bg-[#070B1A] text-white overflow-hidden py-6  md:py-16 sm:py-20">
      ...
      <div className="relative w-[95%] max-w-7xl mx-auto px-2 sm:px-4">
        ...
        >
          {/* Card */}
          {[
            { img: portfoiliImg, title: "Portfolio Website", tech: "React / TypeScript / Tailwind", category: "Web", link: "https://dheeraj-portfolio-rosy.vercel.app", github: "https://github.com/dheeraj-mahara/portfolio", pending: false },
            { img: chatAppImg, title: "Chat Application", tech: "React / Next.js / Socket.io ", category: "App", link: "https://chat-vibe-theta.vercel.app", github: "https://github.com/dheeraj-mahara/ChatappFrountend", pending: false },
            { img: gameImg, title: "Snake Game", tech: "JavaScript / HTML / CSS", category: "Web", link: "https://69d72a6a29518ead87b8c6df--dsnake-leader.netlify.app", github: "https://github.com/dheeraj-mahara/DheerajMahara", pending: false },

            { img: kiddo, title: "Kid's Game", tech: "Next.js / TypeScript / Tailwind CSS ", category: "Web", link: "https://kiddo-omega.vercel.app/", github: "https://github.com/dheeraj-mahara/kids-learning-app", pending: false },
            {
              img: serviceHub,
              title: "ServiceHub",
                ...
                >                <motion.img
                  ...
                  <div className="flex justify-center flex-wrap gap-6 mt-8">
                    ...
                    {project.pending == false ? (
                      ...
                      <p className=" font-extrabold text-orange-300 tracking-wider ">
                        Currently Building
                      </p>)}
